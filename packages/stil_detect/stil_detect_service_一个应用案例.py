...
if __name__ == "__main__":
    ...
    single_predictor = STILPredictor(decoder, infer_module, json_schema_path, data_type_keyword, "")
    # batch图片schema
    json_schema_path2 = os.path.join(root_path, 'config', 'batch_image_schema.json')
    batch_predictor = STILPredictor(decoder, infer_module, json_schema_path, data_type_keyword, "")
